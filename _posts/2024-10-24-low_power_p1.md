---
layout: post
title: "UPF低功耗实现系列博客——1 低功耗基础与UPF介绍"
date:   2024-10-24
tags: [low power]
comments: true
author: Shuhao
...
电路信号翻转分为功能翻转和虚假翻转（或毛刺，Glitch）。当门的两个输入信号不同时到达时，由于路径延迟不匹配，会导致输出产生虚假翻转。
...
<p style="text-align:center">
  <img src="../images/image-20230629104506057.png" width="65%" alt="先进工艺制程PPA比较" />
  <br/>
  <em style="color:#999; display:inline-block; border-bottom:1px solid #d9d9d9; padding:2px;">先进工艺制程PPA比较</em>
</p>
...
- 增加时序收敛难度
  ...
  - 时钟域切换、模式切换需要特殊控制
<p style="text-align:center">
  <img src="../images/image-20230629110415060.png" width="65%" alt="多电压域架构/电源关断" />
  <br/>
  <em style="color:#999; display:inline-block; border-bottom:1px solid #d9d9d9; padding:2px;">多电压域架构/电源关断</em>
</p>
...
<p style="text-align:center">
  <img src="../images/image-20230629111142012.png" width="65%" alt="时钟门控/多阈值电压单元" />
  <br/>
  <em style="color:#999; display:inline-block; border-bottom:1px solid #d9d9d9; padding:2px;">时钟门控/多阈值电压单元</em>
</p>
...
<p style="text-align:center">
  <img src="../images/image-20230629111520393.png" width="65%" alt="多位寄存器优化" />
  <br/>
  <em style="color:#999; display:inline-block; border-bottom:1px solid #d9d9d9; padding:2px;">多位寄存器优化</em>
</p>
...
<p style="text-align:center">
  <img src="../images/image-20230629113117196.png" width="65%" alt="低功耗实现示例（shorten/pin swap/merge）" />
  <br/>
  <em style="color:#999; display:inline-block; border-bottom:1px solid #d9d9d9; padding:2px;">低功耗实现示例（shorten/pin swap/merge）</em>
</p>  
...
<p style="text-align:center">
  <img src="../images/image-20230629134449799.png" width="65%" alt="系统功耗优化层次" />
  <br/>
  <em style="color:#999; display:inline-block; border-bottom:1px solid #d9d9d9; padding:2px;">系统功耗优化层次</em>
</p>
...
<p style="text-align:center">
  <img src="../images/image-20230629134817228.png" width="65%" alt="UPF发展历史" />
  <br/>
  <em style="color:#999; display:inline-block; border-bottom:1px solid #d9d9d9; padding:2px;">UPF发展历史</em>
</p>
...
- 低功耗单元规则（Isolation Cell、Level Shifter、Power Switch）
- 芯片边界供电定义（Boundary Ports）
- IP单元供电描述（Global Net Connectivity Rule）
